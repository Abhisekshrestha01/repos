...
using MvcEntityInsertUpdate;
using MvcEntityInsertUpdate.Models;

namespace MvcEntityInsertUpdate.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult EmployeesByDepartment()
        {
            var employees = db.Employees.Include("Department")
                .GroupBy(n => n.Department.Name)
                .Select(y => new DepartmentTotal
                {
                    Name = y.Key,
                    Total = y.Count()
                }).ToList().OrderByDescending(n =>n.Total);
