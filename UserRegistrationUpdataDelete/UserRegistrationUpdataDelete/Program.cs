...
namespace UserRegistrationUpdataDelete
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (flag == true)
            {
                ...
                Console.WriteLine("Enter: \"R\" to Register User \"V\" to View All \"D\" to View detail \"U\" to Update the User \"Remove\" to Remove user  \"E\" to Exit");
