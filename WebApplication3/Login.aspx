...
<body>
    ...
    <div style="background-attachment: fixed">
        ...
        <asp:LinkButton ID="LinkButton1"  Font-Bold="True" Style="z-index: 103;
            left: 667px; position: absolute; top: 20px" >Admin</asp:LinkButton>
        <asp:LinkButton ID="LinkButton2"  Font-Bold="True" Style="z-index: 104;
            left: 615px; position: absolute; top: 20px">Home</asp:LinkButton>
        <asp:LinkButton ID="LinkButton3"  Style="z-index: 105; left: 646px;
            position: absolute; top: 214px; height: 20px;"  Font-Bold="True">Sign Up</asp:LinkButton>
