...
namespace DemoLibrary.Tests
{
    public class DataAccessTests
    {
        ...
        public void ConvertModelsToCSV_ShouldWork()
        {
            ...
            List<PersonModel> people = new List<PersonModel>
            {
                new PersonModel { FirstName = "Mark", LastName="Jerry"},
                new PersonModel { FirstName = "Mark1", LastName="Jerry2"}
            };
            //Act
            List<string> stringlst = DataAccess.ConvertModelsToCSV(people);

            //Assert
            Assert.NotEmpty(stringlst);
